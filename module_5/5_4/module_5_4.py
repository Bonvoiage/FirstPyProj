...
#         print(f"это первый эелемент {first}")
#         print(f"это второй эелемент {second}")
#         print(f"это третий эелемент {third}")

# ex = Example('data', third=3.14, second=25)
...
class House:
    ...
    def __new__(cls, *args, **kwargs):
        # cls.houses_history.append(args[0]) Можно так, а можно в ините
        return object.__new__(cls)
