...
class User:
    def __init__ (self, nickname : str, password : int, age : int):
        db_users = {}                  #создал базу данных юзеров
        self.db_users = db_users       #сделал чтобы можно было обращаться к user.db_users
        self.nickname = nickname       #обращение к user.nickname
        self.password = self.db_users[nickname][0] #обращение к user.password
        self.age = age                 #обращение к user.age
        
    def add_user_to_db(self, username, password, age):
        self.db_users[username] = [hash(password), age] #добавил юзера в базу данных



class Video:
    
    def __init__(self, tittle: str, duration: int, time_now: int, adult_mode: bool):
        db_videos = {}                  #создал базу данных видео
        self.db_videos = db_videos      #сделал чтобы можно было обращаться к video.db_videos
        self.title = tittle             #обращение к video.title
        self.duration = duration        #обращение к video.duration
        self.time_now = time_now        #обращение к video.time_now
        self.adult_mode = adult_mode    #обращение к video.adult_mode

    def add_video_to_db(self, tittle : str, duration : int, time_now : int, adult_mode : bool):
        self.db_videos[tittle] = [duration, time_now, adult_mode] #добавил видео в базу данных
...
class UrTube:
    ...
    def register(self, username, password, age):
        User.add_user_to_db(username, password, age)  #добавил юзера в базу данных класса юзер

    def add(self, tittle, duration, time_now = 0, adult_mode=False):
        Video.add_video_to_db(tittle, duration, time_now, adult_mode)  #добавил видео в базу данных класса видео
