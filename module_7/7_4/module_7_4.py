...
score_1 = 40
team1_time = 1552.512
team1_tittle = "Мастера кода"

team2_num = 6
score_2 = 42
team2_time = 2153.31451
team2_tittle = "Волшебники данных"
...
if score_1 > score_2 or score_1 == score_2 and team1_time > team2_time:
    result = f"Победа команды {team1_tittle}!"
elif score_1 < score_2 or score_1 == score_2 and team1_time < team2_time:
    result = f"Победа команды {team2_tittle}!"
else:
    result = "Ничья!"

print("В команде %s, Колличество участников : %s" % (team1_tittle, team1_num))
print("Итого сегодня в командах участников: %s и %s человек!" % (team1_num, team2_num))
print("")
print("Команда {team2_tittle} решила {score_2} задач".format(team2_tittle = team2_tittle, score_2 = score_2))
print("Команда {team1_tittle} решила {score_1} задач, за {team1_time}с".format(team1_tittle = team1_tittle, score_1 = score_1, team1_time = team1_time))
print("")
