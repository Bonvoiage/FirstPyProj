#Практическая работа по уроку "Динамическая типизация 1_3"
...
name = "Sergey"                        #Создайте переменную name и присвойте ей значение вашего имени (строка).
age = 29                               #Создайте переменную age и присвойте ей значение вашего возраста (целое число).
id_student = True                      #Создайте переменную is_student и присвойте ей значение True (логическое значение).
print("Name: ", name)                  #Выведите значение переменной name на экран
print("Age: ", age)                    #Выведите значение переменной age на экран.
age += 12                              #Перезапишите в age текущее значение переменной age + новое.
print("New age: ", age)                #Новое значение age
print("ID Student: ", id_student)      #Выведите значение переменной is_student на экран.