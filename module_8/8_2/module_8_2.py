...
def personal_sum(numbers):
    ...
    for i in numbers:
        try:
            ...
            incorrect_data += 1
            print(f"В '{numbers}' введен некорректный тип данных : {i}")
    return result, incorrect_data, amount_of_numbers
...
def calculate_average(numbers):
    avg_calc = 0
    try:
        sum_list = personal_sum(numbers)
        avg_calc = sum_list[0] / sum_list[2]
    except ZeroDivisionError:
        avg_calc = 0
    except TypeError:
            print(f"В {numbers} введен некорректный тип данных")
    return avg_calc
