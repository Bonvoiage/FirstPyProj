...
print("Изначальные значения функции")
print_params()
print()
...
values_list = [3, "stroke", True]                                                        # Создайте список values_list с тремя элементами разных типов.
values_dict = {"a" : [4, 5, "stroke", True],"b" : "Vem", "c" : 6}                        # Создайте словарь values_dict с тремя ключами, соответствующими параметрам функции print_params, и значениями разных типов.
print("Передайте values_list и values_dict в функцию print_params, используя распаковку параметров (* для списка и ** для словаря).")
print("Меняю значения на список") 
print_params(*values_list)
print("Меняю значения на словарь") 
